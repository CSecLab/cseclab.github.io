...
expected_output(zhang, eq, prolog, [true]).    
expected_output(zhang, aug(eq), prolog, [true]).    
...
expected_output(subs_eq, eq, prolog, [not(a=b)]).
...
expected_output(shankar1, eq, prolog, [true]).
...
expected_output(frocos2000, eq, prolog, [true]).
...
expected_output(eq_aug_zhang1, eq, prolog, [true]).
expected_output(eq_aug_zhang1, aug(eq), prolog, [true]).
...
expected_output(eq_aug_zhang2, aug(eq), prolog, [x*y+z=x*y+k]).
...
expected_output(zhang_la, la, none, [true]).
expected_output(zhang_la, aug(la), none, [true]).
expected_output(zhang_la, aug(eq_la), none, [true]).
...
expected_output(zhang_la_bis, aug(la), prolog, [true]).
expected_output(zhang_la_bis, aug(eq_la), prolog, [true]).
...
expected_output(subs_la, la, prolog, [not(d>b)]).
expected_output(subs_la, aug(eq_la), prolog, [not(d>b)]).
...
expected_output(trans1, la, prolog, [true]).
expected_output(trans1, aug(eq_la), prolog, [true]).
...
expected_output(trans2, la, prolog, [true]).
expected_output(trans2, aug(eq_la), prolog, [true]).
...
expected_output(trans3, la, prolog,     [not(b>c),not(d>b),d-2>c]).
expected_output(trans3, aug(eq_la), prolog, [not(b>c),not(d>b),d-2>c]).
...
expected_output(frocos2000_la, aug(eq_la), none, [true]).
...
input(bm94_simplified, [not(min(d)=<max(d)),not(k>=0),
			...
			l<max(d)+k]).
expected_output(bm94_simplified, la, prolog, [true]).
expected_output(bm94_simplified, aug(eq_la), prolog, [true]).
...
expected_output(bm94, aug(la), prolog, [true]).
expected_output(bm94, aug(eq_la), prolog, [true]).
...
expected_output(bm95, aug(la), none, [true]).
expected_output(bm95, aug(eq_la), none, [true]).
...
expected_output(bm101, aug(la), prolog, [true]).
expected_output(bm101, aug(eq_la), prolog, [true]).
...
Notice tha we must associate the nested multiplications to the right 
(in Prolog *  associate to the left), otherwise augment
...
input(bm102, [ms(c)+ms(d)*ms(d)+ms(b)*ms(b)<
               ms(c)+ms(b)*ms(b)+2*(ms(d)*ms(d))*ms(b)+
                ms(d)*(ms(d)*(ms(d)*ms(d)))]).
expected_output(bm102, aug(eq_la), prolog, [true]).
...
input(bm102_bis, [ms(c)+ms(d)*ms(d)+ms(b)*ms(b)<
                   ms(c)+ms(b)*ms(b)+2*(ms(d)*(ms(d)*ms(b)))+
                    ms(d)*(ms(d)*(ms(d)*ms(d)))]).
expected_output(bm102_bis, aug(eq_la), prolog, [true]).
...
expected_output(frocos2000_aug, aug(la), none, [true]).
...
expected_output(kapur_nie_11, aug(eq_la), prolog, [true]).
...
expected_output(nl-0, aff(la), prolog, [true]).    
expected_output(nl-0, aff(eq_la), prolog, [true]).    
...
expected_output(nl-0-bis, aff(la), prolog, [true]).    
expected_output(nl-0-bis, aff(eq_la), prolog, [true]).    
...
expected_output(nl-1, aff(la), prolog, [true]).    
expected_output(nl-1, aff(eq_la), prolog, [true]).    
...
expected_output(nl-1-bis, aff(la), prolog, [true]).    
expected_output(nl-1-bis, aff(eq_la), prolog, [true]).    
...
expected_output(nl-example-bjorner, aff(la), prolog, [true]).    
expected_output(nl-example-bjorner, aff(eq_la), prolog, [true]).    
...
expected_output(nl-1-harrison, aff(la), prolog, [true]).    
expected_output(nl-1-harrison, aff(eq_la), prolog, [true]).    
...
expected_output(nl-1-bis-harrison, aff(la), prolog, [true]).    
expected_output(nl-1-bis-harrison, aff(eq_la), prolog, [true]).    
...
expected_output(nl-2-harrison, aff(la), prolog, [true]).    
expected_output(nl-2-harrison, aff(eq_la), prolog, [true]).    
...
input(nl-4-bis-harrison, [not(x<0),
                              ...
                              not(7*x*x-5*x+3>0), 
                              not(x*x-8*x+1=0)]).
expected_output(nl-4-bis-harrison, aff(la), prolog, [true]).    
expected_output(nl-4-bis-harrison, aff(eq_la), prolog, [true]).    
...
expected_output(nl-1-pvs, aff(la), prolog, [true]).    
expected_output(nl-1-pvs, aff(eq_la), prolog, [true]).    
...
expected_output(nl-1-bis-pvs, aff(la), prolog, [true]).    
expected_output(nl-1-bis-pvs, aff(eq_la), prolog, [true]).    
...
expected_output(nl-2-pvs, aff(la), prolog, [true]).    
expected_output(nl-2-pvs, aff(eq_la), prolog, [true]).    
...
expected_output(nl-2-bis-pvs, aff(la), prolog, [true]).    
expected_output(nl-2-bis-pvs, aff(eq_la), prolog, [true]).    
...
expected_output(nl-3-pvs, aff(la), prolog, [true]).    
expected_output(nl-3-pvs, aff(eq_la), prolog, [true]).    
...
expected_output(nl-3-bis-pvs, aff(la), prolog, [true]).    
expected_output(nl-3-bis-pvs, aff(eq_la), prolog, [true]).    
...
expected_output(nl-4-pvs, aff(la), prolog, [true]).    
expected_output(nl-4-pvs, aff(eq_la), prolog, [true]).    
...
expected_output(nl-4-bis-pvs, aff(la), prolog, [true]).    
expected_output(nl-4-bis-pvs, aff(eq_la), prolog, [true]).    
...
expected_output(nl-8-pvs, aff(la), prolog, [true]).    
expected_output(nl-8-pvs, aff(eq_la), prolog, [true]).    
...
expected_output(nl-8-bis-pvs, aff(la), prolog, [true]).    
expected_output(nl-8-bis-pvs, aff(eq_la), prolog, [true]).    
...
expected_output(nl-9-pvs, aff(la), prolog, [true]).    
expected_output(nl-9-pvs, aff(eq_la), prolog, [true]).    
...
expected_output(nl-9-bis-pvs, aff(la), prolog, [true]).    
expected_output(nl-9-bis-pvs, aff(eq_la), prolog, [true]).    
...
expected_output(nl-10-pvs, aff(la), prolog, [true]).    
expected_output(nl-10-pvs, aff(eq_la), prolog, [true]).    
...
expected_output(nl-10-bis-pvs, aff(la), prolog, [true]).    
expected_output(nl-10-bis-pvs, aff(eq_la), prolog, [true]).    
...
expected_output(nl-11-pvs, aff(la), prolog, [true]).    
expected_output(nl-11-pvs, aff(eq_la), prolog, [true]).    
...
expected_output(nl-11-bis-pvs, aff(la), prolog, [true]).    
expected_output(nl-11-bis-pvs, aff(eq_la), prolog, [true]).    
...
expected_output(nl-12-bis-pvs, aff(eq_la), prolog, [true]).    
...
expected_output(nl-13-pvs, aff(eq_la), prolog, [true]).    
...
expected_output(nl-13-bis-pvs, aff(eq_la), prolog, [true]).    
...
input(nl-1-termination, 
  	      [ms(c)+ms(d)*ms(d)+ms(b)*ms(b)<
                     ms(c)+ms(b)*ms(b)+2*(ms(d)*(ms(d)*ms(b)))+
                      ms(d)*(ms(d)*(ms(d)*ms(d)))]).
expected_output(nl-1-termination, aug_aff(la), prolog, [true]).    
...
expected_output(nl-2-termination, aug_aff(la), prolog, [true]).    
expected_output(nl-2-termination, aug_aff(eq_la), prolog, [true]).    